<share-dialog>
  ...
  <div if={ show } class="disabledArea">
    <div class="dialogArea">
      ...
      <div class="messageArea">
        ...
        <div class="qrImage"><img class="qrCode" alt="QR-Code" src={ qrCodeImage }></div>
      </div>
  ...
  <script>
    ...
    // ダイアログ表示イベント受信
    self.observer.on(EVENT_SHOW_SHARE_DIALOG, function(param) {
      console.log('RCV '+EVENT_SHOW_SHARE_DIALOG, param)
      // ダイアログ表示
    ...
    showDialog(param) {
      ...
      // TODO : URL を指定して画像を生成する予定
      // 将来的には localStorage の内容をパラメータ化して
      // URL にくっつける予定
      self.qrCodeImage = 'assets/img/QR_Code.png'
